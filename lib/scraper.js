...
export async function getMonsterData(jobTitle = 'software', jobCity = 'washington', jobState = 'dc'){
    const htmlMonster = getHTML(`https://www.monster.com/jobs/search/?q=${jobTitle}&where=${jobCity}__2C-${jobState}&intcid=skr_navigation_nhpso_searchMain&stpage=1&page=5`); //this grabs the html link using axios being imported from our getHTML function and saves it in a variable
